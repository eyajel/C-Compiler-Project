...
int etiquette=0;
//Définition de la structure d'un symbole
...
/*********Fct caractereSuivant*********/
char caractereSuivant(FILE* f){
    return fgetc(f);
}
/*********Fct RangerId*********/
//renvoie 1 si le string est un mot clé , 0 sinon ( tverifi si chaine heyya mot cle oale )
...
// Implementation des procedures des regles de production (Mte3 ambiguite)
void P() {
	accepter("program");
	accepter("id");
	accepter(";");
...
char C_prime() {
    ...
    if (strcmp(symbole,"oprel")==0){
        ...
        type=Exp_simple();
        if(strcmp(ch,"<")==0){
            emettre1("Comparer-si-inf");
        }else if (strcmp(ch,"<=")==0){
            emettre1("Comparer-si-inf-ou-egal");
        }else if(strcmp(ch,">")==0){
            emettre1("Comparer-si-sup");
        }else if(strcmp(ch,">=")==0){
            emettre1("Comparer-si-sup-ou-egal");
        }else if(strcmp(ch,"=")==0){
            emettre1("Comparer-si-egal");
        }else if(strcmp(ch,"<>")==0){
            emettre1("Comparer-si-non-egal");
        }
        return type;
    }
    else{return 'v';}
